...
const Storage = () => {
  const [changingDefaultVal, setChangingDefaultVal] = useState({
    text: "initial default value",
  });
    ...
    <div>
      ...
      <div>
        <button
          ...
          onClick={() => setChangingDefaultVal({ text: "new default value" })}
        >
