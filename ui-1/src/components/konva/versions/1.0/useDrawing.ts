...
// import KonvaFreeDrawingTool from "@/components/konva/createFreeDrawTool";
...
// ) => {
//   const { applyDraft, updateDraft } = useDrawingStore();
...
//     toolRef.current = new KonvaFreeDrawingTool({
//       onStrokeStart: () => {
...
//         });
//       },
//       onStrokeUpdate: (konvaPoints) => {
//         updateDraft(konvaPoints);
//       },
//       onStrokeEnd: () => {
//         applyDraft();
//       },
